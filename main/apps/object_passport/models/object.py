...
class Object(BaseModel):
    ...
    latitude = models.DecimalField(max_digits=9, decimal_places=6, verbose_name="Kenglik")
    longitude = models.DecimalField(max_digits=9, decimal_places=6, verbose_name="Uzunlik")
