# Generated by Django 4.1.5 on 2024-11-27 06:37

from django.db import migrations, models
import main.apps.account.models
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to=main.apps.account.models.upload_profile_images)),
                ...
                ('position', models.CharField(choices=[('manager', 'Manager'), ('moderator', 'Moderator'), ('assistant', 'Assistant')], max_length=15)),
