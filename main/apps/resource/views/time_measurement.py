...
from ..serializers import time_measurement as time_measurement_serializer
...
class TimeMeasurementCreateAPIView(generics.CreateAPIView):
    queryset = TimeMeasurement.objects.all()
    serializer_class =  time_measurement_serializer.TimeMeasurementSerializer
...
time_measurement_create_api_view = TimeMeasurementCreateAPIView.as_view()



class TimeMeasurementListAPIView(generics.ListAPIView):
    serializer_class =  time_measurement_serializer.TimeMeasurementSerializer
    authentication_classes = [authentication.JWTAuthentication]
    permission_classes = [permissions.IsAuthenticated]
...
time_measurement_list_api_view = TimeMeasurementListAPIView.as_view()



class TimeMeasurementDetailAPIView(generics.RetrieveUpdateDestroyAPIView):
    queryset = TimeMeasurement.objects.all()
    serializer_class =  time_measurement_serializer.TimeMeasurementSerializer
    authentication_classes = [authentication.JWTAuthentication]
    permission_classes = [permissions.IsAuthenticated]
...
time_measurement_detail_api_view = TimeMeasurementDetailAPIView.as_view()
