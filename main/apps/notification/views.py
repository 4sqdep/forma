from main.apps.notification.models import Notification
...
from . import serializers as notification_serializer
...
class NotificationListAPIView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = Notification.objects.filter(Q(employee=user) | Q(manager=user))
        return queryset
...
notification_list_api_view = NotificationListAPIView.as_view()
...
notification_detail_api_view = NotificationDetailAPIView.as_view()
